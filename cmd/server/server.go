...
import (
	...
	go_start_project "go-start-project"
	"go-start-project/ent"
	"go-start-project/ent/migrate"
	...
	_ "go-start-project/ent/runtime"
...
func main() {
	...
	client, err := ent.Open("mysql", "root:pw@/my?parseTime=true")
	if err != nil {
	...
	srv := handler.NewDefaultServer(go_start_project.NewSchema(client))
